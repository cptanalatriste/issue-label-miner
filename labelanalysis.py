...
def main():
    ...
    using_custom_labels.sample(n=SAMPLE_SIZE, random_state=321).to_csv(SAMPLE_CUSTOM_LABELS_FILE)
    print SAMPLE_SIZE, "samples with custom labels saved in ", SAMPLE_CUSTOM_LABELS_FILE
